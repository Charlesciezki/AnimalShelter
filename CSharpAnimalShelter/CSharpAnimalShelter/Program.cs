...
namespace CSharpAnimalShelter
{
    ...
    //Must be able to add an animal to the system [x]
    //Must be able to remove an animal from the system and collect money from an adopter(object adopting an animal) []
    //Must be able to track which animals have had their shots and give animals their shots if have not received it yet [x]
    ...
    //Keep track of the food the animals need. This means dog will need x amount of dog feed per week, etc.Different animals need different food. [x]
